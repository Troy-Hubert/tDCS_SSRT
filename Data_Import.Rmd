...
data <- read_csv("~/Desktop/Coding/data/SSRT/metric1.csv")
...
output_data = data.frame(
    participant, 
    B1_Mean_GoRT, B1_Go_ACC, B1_Stop_ACC, B1_mean_SSRT, B1_mean_failed_RT,
    B2_Mean_GoRT, B2_Go_ACC, B2_Stop_ACC,B2_mean_SSRT, B2_mean_failed_RT,
    B3_Mean_GoRT, B3_Go_ACC, B3_Stop_ACC,B3_mean_SSRT, B3_mean_failed_RT,
    Combined_Mean_GoRT, Combined_Go_ACC, Combined_Stop_ACC,Combined_mean_SSRT, Combined_mean_failed_RT,
...
#write.csv(output_tab, "~/Desktop/Coding/data/SSRT_Output/Le_Holy_Grail.csv")
  write.csv(output_tab, "~/Desktop/Coding/data/SSRT_Output/i_MEAN_its_fine.csv")
```
